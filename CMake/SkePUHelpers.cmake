...
macro(skepu_filter_args)
	...
	foreach(arg ${ARGN})
		...
		elseif(${arg} STREQUAL "SRC")
			...
			set(_skepu_src_arg OFF)
			set(_compopt_arg OFF)
		elseif(${arg} STREQUAL "PRECOMPILE_OPTIONS")
			set(_fnames_arg OFF)
			set(_src_arg OFF)
			set(_skepu_src_arg OFF)
			set(_compopt_arg ON)
...
function(skepu_add_executable name)
	...
	target_compile_options(${name} PRIVATE $<$<COMPILE_LANGUAGE:CUDA>:${_target_cxxflags}>)
